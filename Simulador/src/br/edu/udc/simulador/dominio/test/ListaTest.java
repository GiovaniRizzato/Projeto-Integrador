...
public class ListaTest {
	...
	public void adiciona_CasoFaliz() {
		...
		assertEquals("Deveria ter tamanho 15", 15, lista.tamanho());
	}

	@Test(expected = RuntimeException.class)
	public void adiciona_AdicionandoNull() {

		Lista<Integer> fila = new Lista<>();
		Integer vazio = null;
		fila.adiciona(vazio);
	...
	@Test
	public void adiciona_vetor_CasoFeliz() {
		...
		lista.adiciona(valores);

		assertEquals("Deveria ter tamanho 15", 15, lista.tamanho());
	}
	
	@Test
	public void adiciona_vetor_comNulo() {
		...
		assertEquals("Deveria ter tamanho 14", 14, lista.adiciona(valores));
	}
	/*
